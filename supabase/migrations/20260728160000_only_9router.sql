...
-- O usuário configura os modelos direto pelo 9router
-- O endpoint base é resolvido pelo motor (resolveEndpoint adiciona /v1/chat/completions)
...
insert into public.ai_provider_settings (
  ...
  ('forza-1-flash', '9router', 'Forza 1.0 Flash (9router)',
   'http://localhost:20128/v1', 'deepseek-chat',
   false, 1, true),
  ...
  ('forza-2-5-thinking', '9router', 'Forza 2.5 Thinking (9router)',
   'http://localhost:20128/v1', 'deepseek-reasoner',
   false, 4, true)
